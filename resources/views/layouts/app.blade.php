...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('img/logo2.png') }}" type="image/gif" sizes="16x16">
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark shadow-sm" style="background-color: #5fbb49;">
            <div class="container">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            @if (Auth::user()->hasRole('user'))
                                <li class="nav-item ml-2 mr-2 mt-1">
                                    <a class="nav-link" href="{{ route('register-sale') }}">{{ __('Register a Sale') }}</a>
                                </li>

                                <li class="nav-item ml-2 mr-2 mt-1">
                                    <a class="nav-link" href="{{ route('verify-info') }}">{{ __('Verification') }}</a>
                                </li>
                            @endif

                            @if (Auth::user()->hasRole('admin'))
                                <li class="nav-item ml-2 mr-2 mt-1">
                                    <a class="nav-link" href="{{ route('manage-users') }}">{{ __('User Management') }}</a>
                                </li>
                            @endif
                            ...
                            <li class="nav-item dropdown ml-2 mr-2 mt-1">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                    <img class="rounded-circle ml-1" width="25" src="{{ asset('img/profile/' . Auth::user()->profile_path) }}">
                                </a>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @if (Auth::user()->hasRole('user'))
                                    <a class="dropdown-item" href="{{ route('user_entries') }}">
                                        {{ __('Your Entries') }}
                                    </a>
                                    @endif
    ...
    <div class="main-footer widgets-dark typo-light">
        <div class="container">
            <div class="row">
                ...
                <h5 class="widget-title">Bhutan Telecom</h5>
                <p>Bhutan Telecom is a telecommunications and Internet services provider in the Kingdom of Bhutan. It is the sole fixed line telephony provider in the country. It also operates the B-Mobile mobile service and the DrukNet Internet service.</p>
                </div>
                </div>
                ...
                <li>
                <div class="thumb-content"><a href="#.">DHI</a></div>	
                </li>
                <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p><img src="{{ asset('img/footer-logo.png') }}" width="60">Bhutan Telecom Limited © Copyright 2021. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
